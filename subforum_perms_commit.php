...
while($row = mysqli_fetch_assoc($result)){
    ...
    mysqli_query($conn, "UPDATE subcat_perms SET read_forum = '$read_forum', post_replies = '$post_replies', post_topics = '$post_topics' WHERE group_id = '$group_id' AND subcat_id = '$id'") or die(mysqli_error($conn));
  //  if(!mysqli_affected_rows($conn)){
  //      mysqli_query($conn, "INSERT INTO subcat_perms (group_id, subcat_id, read_forum, post_replies, post_topics) VALUES ('$group_id', '$id', '$read_forum', '$post_replies', '$post_topics')") or die(mysqli_error($conn));
  //  }
